          ...
          <div className="container px-4 md:px-8 mx-auto max-w-7xl">
            <ScrollReveal>
              <div className="mb-16 text-center max-w-3xl mx-auto">
                ...
                <p className="mt-6 text-lg text-sidebar-foreground/70 leading-relaxed">Everything you need to build scalable payment flows securely and reliably.</p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="group flex flex-col items-start gap-3 sm:gap-5 p-5 sm:p-8 border border-sidebar-border bg-sidebar-accent/50 rounded-2xl shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-sidebar-border/80 hover:shadow-md hover:bg-sidebar-accent">
                  <div className="p-3 bg-white/10 rounded-xl transition-colors duration-300 group-hover:bg-white/20">
                    <Code2 className="size-6 text-sidebar-foreground transition-transform duration-300 group-hover:scale-110" />
                  </div>
                ...
                <div className="group flex flex-col items-start gap-3 sm:gap-5 p-5 sm:p-8 border border-sidebar-border bg-sidebar-accent/50 rounded-2xl shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-sidebar-border/80 hover:shadow-md hover:bg-sidebar-accent">
                  <div className="p-3 bg-white/10 rounded-xl transition-colors duration-300 group-hover:bg-white/20">
                    <Workflow className="size-6 text-sidebar-foreground transition-transform duration-300 group-hover:scale-110" />
                  </div>
                ...
                <div className="group flex flex-col items-start gap-3 sm:gap-5 p-5 sm:p-8 border border-sidebar-border bg-sidebar-accent/50 rounded-2xl shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-sidebar-border/80 hover:shadow-md hover:bg-sidebar-accent">
                  <div className="p-3 bg-white/10 rounded-xl transition-colors duration-300 group-hover:bg-white/20">
                    <TestTube2 className="size-6 text-sidebar-foreground transition-transform duration-300 group-hover:scale-110" />
                  </div>
              ...
              <div className="flex-1 space-y-8 text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                  <div className="flex items-center gap-2 text-sm font-medium text-sidebar-foreground bg-sidebar-accent/50 px-5 py-3 rounded-full border border-sidebar-border shadow-sm">
                    <Check className="size-4 text-sidebar-foreground" /> No XML payloads
                  </div>
                  <div className="flex items-center gap-2 text-sm font-medium text-sidebar-foreground bg-sidebar-accent/50 px-5 py-3 rounded-full border border-sidebar-border shadow-sm">
                    <Check className="size-4 text-sidebar-foreground" /> Native JSON
                  </div>
                  <div className="flex items-center gap-2 text-sm font-medium text-sidebar-foreground bg-sidebar-accent/50 px-5 py-3 rounded-full border border-sidebar-border shadow-sm">
                    <Check className="size-4 text-sidebar-foreground" /> Bearer Auth
                  </div>
                </div>
              </div>
