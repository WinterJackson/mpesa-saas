...
/**
 * Sign-in card, themed off the resolved light/dark theme so every Clerk surface
 * (card, inputs, social buttons, popovers) uses the same PaySwift tokens as the
 * rest of the app — card-black in dark mode. Shared color variables come from
 * clerkThemeVariables; the elements below only fine-tune layout/spacing.
 */
